...
SECRET_KEY = "django-insecure-@)%-refhjb6d93#)*gk9bv$@ol7h!2l+24m8@os8*4w3h()uj_"
DEBUG = True
...
INSTALLED_APPS = [
    ...
    "django.contrib.staticfiles", 'rest_framework', 'server', 'corsheaders'
]
...
MIDDLEWARE = [
    ...
    "django.contrib.messages.middleware.MessageMiddleware", "django.middleware.clickjacking.XFrameOptionsMiddleware", 'corsheaders.middleware.CorsMiddleware',
]
